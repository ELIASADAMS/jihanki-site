...
const ARCHIVE = {
    ...
    text: [
        ...
        { id:"aokigahara-project", title:"AOKIGAHARA — PROCEDURAL AMBIENT PENTALOGY", date:"2026", type:"project", category:"text", author:"eli", project:"aokigahara", projectPath:"projects/aokigahara/index.html", file:"documents/projects/aokigahara.md" }
    ],
...
#artifact-body audio.artifact-audio,#artifact-body video.artifact-video,#artifact-body .markdown-audio audio{display:block;width:100%;max-width:620px;margin:18px auto;padding:7px;border:1px solid rgba(255,255,255,.13);border-radius:0;background:#050505;filter:grayscale(1) contrast(.92);box-shadow:inset 0 0 18px rgba(255,255,255,.025),0 0 16px rgba(0,0,0,.65)}
#artifact-body audio.artifact-audio{height:46px}#artifact-body video.artifact-video{max-height:65vh;object-fit:contain}
...
(function installRuntime(){
    ...
    function sfx(name){const now=Date.now();if(now-lastSFX<45)return;lastSFX=now;const a=new Audio(SOUND[name]);a.volume=name==="coin"?.55:.4;a.play().catch(()=>{})}
